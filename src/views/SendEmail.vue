              ...
              <b-form @submit.prevent="sendMessage">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10 d-flex mt-auto mb-auto" >
                    <b-form-checkbox value="0" size="lg" class="me-2 ms-2"></b-form-checkbox> <span class="mt-auto mb-auto"></span>
                    <b-form-checkbox value="1" size="lg" class="me-2 ms-2"></b-form-checkbox> <span class="mt-auto mb-auto"></span>
