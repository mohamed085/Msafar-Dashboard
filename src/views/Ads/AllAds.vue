      ...
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tr class="bg-success text-white">
            ...
            <th scope="col">صفحات العرض</th>
            <th scope="col">تاريخ بداية عرض الاعلان</th>
            <th scope="col">تاريخ نهاية عرض الاعلان</th>
          ...
          <tr v-for="res in data" :key="res.id">
            ...
            <td>
              <span v-if="res.user_appear == 1">صفحات العميل</span>
              <br>
              <span v-if="res.masafr_appear == 1">صفحات المسافر</span>
              <br>
            </td>
